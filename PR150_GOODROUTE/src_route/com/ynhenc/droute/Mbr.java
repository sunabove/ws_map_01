...
public class Mbr {
	...
	public boolean isIncludes(PntInterface point) {
	...
	public int getTopology(PntInterface point) {
	...
	public PntShort [] getCornerPointList() {
		// 최소점에서 부터 출발하여 시계방향으로 돌아가면서 구석점을 배열로 반환한다.
		if (this.cornerPointList == null) {
			this.cornerPointList = new PntShort[] {
					PntShort.pntShort(minX, minY), PntShort.pntShort(minX, maxY),
					PntShort.pntShort(maxX, maxY), PntShort.pntShort(maxX, minY), };
		}
	...
	private transient PntShort[] cornerPointList;
	...
	public static Mbr calculateMbr( PntShort [] points) {
