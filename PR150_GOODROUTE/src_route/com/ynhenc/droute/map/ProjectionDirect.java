...
public class ProjectionDirect extends Projection {
	...
	public double getMapScale() {
		...
		PntShort p = this.toSpatial(0, 0);
		PntShort q = this.toSpatial(width, 0);
	...
	@Override
	public PntShort toSpatial(int x, int y) {
		return PntShort.pntShort( (x - this.tx) / this.scale, (this.ty - y) / this.scale);
