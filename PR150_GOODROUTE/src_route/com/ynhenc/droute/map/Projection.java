...
import com.ynhenc.droute.Mbr;
import com.ynhenc.droute.PntInterface;
...
public abstract class Projection extends GisComLib {
	...
	public final PntShort toGraphics(PntInterface p) {
		return this.toGraphics(p.getX(), p.getY());
	}
	...
	public abstract PntShort toSpatial(int x, int y);
