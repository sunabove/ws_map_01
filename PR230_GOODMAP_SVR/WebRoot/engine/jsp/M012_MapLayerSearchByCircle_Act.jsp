...
<%
	...
	String layerName = req.getParameter("srchLayerName");
	...
	if (layerName != null && layerName.trim().length() > 0) {
		...
		if (layer != null) {
			...
			GeoPoint center = req.getGeoPointConverted("circleMapX", "circleMapY", gisProject); 

			Double radius = req.getDouble("circleRadius");

			if (center != null && radius != null) {

				Layer srchLayer = layer.getLayerSearchByCircle(center, radius);

				request.setAttribute("srchLayer", srchLayer);
