...
<title>MapControl V1.0.006 ${visitNo}</title>
...
// map tooltip
var useToolTip = ${ empty param.useToolTip ? 0 : param.useToolTip } ;
// map mouse wheel
var useMouseWheel = ${ empty param.useMouseWheel ? 1 : param.useMouseWheel } ;
// map double click
var useDoubleClick = ${ empty param.useDoubleClick ? 1 : param.useDoubleClick } ;
...
>
	...
	<div id="toolTipPane" style="position: absolute; top: 6 ; left: 6 ; z-index: 20; cursor:default; visibility: hidden; " >
	...
	<div id="mapCompassPane" style="position: absolute; top: 6px ; left: ${ width - 62 }px ; z-index: 20; cursor:move; visibility:hidden; " >
        <img src="../image/map/mapCompass_05.gif" border="0" width="60" height="60" align="absmiddle" />
    </div>
    <div id="mapScalePane" class="mapScalePane" style="maring: 0; padding: 0; position: absolute; top: ${ height - 50 }px ; left: ${ width - 140 }px ; z-index: 20; cursor:hand; visibility:hidden; " >
        <li class="mapScale" ><nobr><span id="mapScaleVal" style="background: ThreeDFace; "></span></nobr></li>
