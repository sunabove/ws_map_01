...
public class DateField extends Field {
	...
	public void put(Calendar inValue) throws xBaseJException {
		...
		super.put(String.valueOf((inValue.get(Calendar.YEAR)) * 10000 + (inValue.get(Calendar.MONTH) + 1) * 100
	...
	public Calendar getCalendar() throws xBaseJException {
		...
		getter.set(Calendar.YEAR, Integer.parseInt(this.get(Calendar.YEAR)));
		getter.set(Calendar.MONTH, Integer.parseInt(this.get(Calendar.MONTH)) - 1);
		getter.set(Calendar.DAY_OF_MONTH, Integer.parseInt(this.get(Calendar.DAY_OF_MONTH)));
		return getter;
	}
