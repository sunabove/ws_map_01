 ...
 * @param name Index file name , can be full or partial pathname
 * @param NDXString database Fields that define the Index, join Fields with "+" do not use spaces
 * @param indatabase DBF object to be associated with
...
private  int  update_entry(Node aNode, NodeKey NDXkey,
                                      int leftleaf,
                                      int rightleaf,
