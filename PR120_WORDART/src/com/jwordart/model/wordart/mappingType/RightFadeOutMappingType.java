...
public class RightFadeOutMappingType extends NonLinearMappingType {
  float w; // 폭 값
  float h; // 높이 값
  float cpY;// 콘트롤 포인트 수직 값
  float a;  // 기울기

  public RightFadeOutMappingType(int type) {
     super(type);
  }
...
public void setControlPoint(WordArt wa) {
     wa.setControlPoint( new ControlPointVertical(wa, 0, 0.485, 0.3, ControlPointVertical.RIGHT) );
  }
}