...
public class BottomFadeOutMappingType extends NonLinearMappingType {
  float w; // 폭 값
  float h; // 높이 값
  float cpX;// 콘트롤 포인트 수평 값
  float a;  // 기울기

  public BottomFadeOutMappingType(int type) {
     super(type);
  }
...
public void setControlPoint(WordArt wa) {
     wa.setControlPoint( new ControlPointHorizontal(wa, 0, 0.493, 0.3) );
  }
}