...
public class jExcelAboutBox extends JDialog implements ActionListener {
  ...
  String product = "java chart project";
  String version = "1.0";
  String copyright = "Copyright (c) Suhng ByuhngMunn";
  String comments = "jchart v1.0";

  public jExcelAboutBox(Frame parent) {
    super(parent);
