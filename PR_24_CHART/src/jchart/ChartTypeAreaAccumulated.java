...
public class ChartTypeAreaAccumulated extends ChartTypeVerticalBarAccumulated {

  public ChartTypeAreaAccumulated() {
  }
  ...
  /**
   ...
   public void setShapeAndStyle(DataSeriesView dataSeriesView) {
      ...
      for(int i = 0; i < len - 1 ; i ++ ) {
          ...
          DataElement [] currRefDes = referenceSeries[ i ].getDataElements(); // reference data elements
          ...
          double currAccuH = pah*( currBaseVal - accuMin )/( accuMax - accuMin );
          ...
          DataElement [] nextRefDes = referenceSeries[ i + 1 ].getDataElements(); // reference data elements
          ...
          double nextAccuH = pah*( nextBaseVal - accuMin )/( accuMax - accuMin );

          double nextH = pah*( nextVal - accuMin )/( accuMax - accuMin );
