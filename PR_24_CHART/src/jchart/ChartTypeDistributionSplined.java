...
public class ChartTypeDistributionSplined extends ChartTypeDistribution implements LinearChartType, FeedbackChartType {

  public ChartTypeDistributionSplined() {
  }
   ...
   public void setShapeAndStyle(DataSeriesView dataSeriesView) {
      ...
      ShapeStyle style = new ShapeStyle( null, color ); // DataElementView Shape Style
...
//          Shape icon = getDataElementIcon( oci, currX, currY );
          ...
          currDev.setShape( new Rectangle2D.Double( currX, currY, 1, 1) );
      }
