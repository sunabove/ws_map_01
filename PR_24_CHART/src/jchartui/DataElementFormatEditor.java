...
/**
 * Title:       데이터 요소 서식 다이얼 로그 박스 클래스<p>
...
public class DataElementFormatEditor extends Editor {
...
//    OptionTab tabOption;
  ...
  //Construct the frame
  public DataElementFormatEditor() {
...
//	this.setLocationRelativeTo(jcalc.JCalc.frame);
  ...
  //Component initialization
    private void jbInit() throws Exception  {
	    ...
	    ResourceBundle bundle = ResourceBundle.getBundle("jchartui/DataElementFormatEditorBundle", JCalcResource.getLocale());

        contentPane = (JPanel) this.getContentPane();
	    contentPane.setLayout(null);
	    this.setSize(new Dimension(447, 413));
        this.setTitle(bundle.getString("formatDataPoint"));    // "데이터 요소 서식"
...
//        tabPaneMain.add(tabOption, bundle.getString("option"));
	...
	public void changeMenuText() {
		...
		this.setTitle(bundle.getString("formatDataPoint"));    // "축 제목 서식"
...
//		initalizeDialog();
	...
	protected void initalizeDialog() {
