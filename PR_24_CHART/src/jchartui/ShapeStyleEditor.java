...
public class ShapeStyleEditor extends Editor {
  // Data.
  public static ShapeStyleEditor shapeStyleEditor = new ShapeStyleEditor();
  private boolean neverShown = true;
  private ShapeStyle shapeStyle = new ShapeStyle() ;
  // 스크롤 바의 증감 여부를 알아내기 위해서 사용된다.
  private int preHeightScrollBarValue, preWidthScrollBarValue,
          preHeightRatioScrollBarValue, preWidthRatioScrollBarValue,
          preLocationXScrollBarValue, preLocationYScrollBarValue,
          preLineWidthScrollBarValue ;
  ...
  // JComboBox fillColorComboBox = new JComboBox(  fillColorComboBoxList );
  ...
  private void jbInit() throws Exception  {
    ...
    halfTransparentCheckBox.addActionListener(new java.awt.event.ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        halfTransparentCheckBox_actionPerformed(e);
      }
    });
    ...
    lineWidthScrollBar.addAdjustmentListener(new java.awt.event.AdjustmentListener() {
      ...
      public void adjustmentValueChanged(AdjustmentEvent e) {
        lineWidthScrollBar_adjustmentValueChanged(e);
      }
    });
    ...
    verifyButton.addActionListener(new java.awt.event.ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        verifyButton_actionPerformed(e);
      }
    });
    ...
    widthRatioTextField.addActionListener(new java.awt.event.ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        widthRatioTextField_actionPerformed(e);
      }
    });
    ...
    widthRatioScrollBar.addAdjustmentListener(new java.awt.event.AdjustmentListener() {
      ...
      public void adjustmentValueChanged(AdjustmentEvent e) {
        widthRatioScrollBar_adjustmentValueChanged(e);
      }
    });
    ...
    rotationAngleScrollBar.addAdjustmentListener(new java.awt.event.AdjustmentListener() {
      ...
      public void adjustmentValueChanged(AdjustmentEvent e) {
        rotationAngleScrollBar_adjustmentValueChanged(e);
      }
    });
    ...
    rotationAngleTextField.addActionListener(new java.awt.event.ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        rotationAngleTextField_actionPerformed(e);
      }
    });
    ...
    widthValueScrollBar.addAdjustmentListener(new java.awt.event.AdjustmentListener() {
      ...
      public void adjustmentValueChanged(AdjustmentEvent e) {
        widthValueScrollBar_adjustmentValueChanged(e);
      }
    });
    ...
    heightValueScrollBar.addAdjustmentListener(new java.awt.event.AdjustmentListener() {
      ...
      public void adjustmentValueChanged(AdjustmentEvent e) {
        heightValueScrollBar_adjustmentValueChanged(e);
      }
    });
    ...
    heightRatioScrollBar.addAdjustmentListener(new java.awt.event.AdjustmentListener() {
      ...
      public void adjustmentValueChanged(AdjustmentEvent e) {
        heightRatioScrollBar_adjustmentValueChanged(e);
      }
    });
    ...
    heightRatioTextField.addActionListener(new java.awt.event.ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        heightRatioTextField_actionPerformed(e);
      }
    });
    ...
    locationXScrollBar.addAdjustmentListener(new java.awt.event.AdjustmentListener() {
      ...
      public void adjustmentValueChanged(AdjustmentEvent e) {
        locationXScrollBar_adjustmentValueChanged(e);
      }
    });
    ...
    locationYScrollBar.addAdjustmentListener(new java.awt.event.AdjustmentListener() {
      ...
      public void adjustmentValueChanged(AdjustmentEvent e) {
        locationYScrollBar_adjustmentValueChanged(e);
      }
    });
    ...
    lineColorComboBox.addActionListener(new java.awt.event.ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        lineColorComboBox_actionPerformed(e);
      }
    });
    ...
    lineKindComboBox.addActionListener(new java.awt.event.ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        lineKindComboBox_actionPerformed(e);
      }
    });
    ...
    fillColorComboBox.addActionListener(new java.awt.event.ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        fillColorComboBox_actionPerformed(e);
      }
    });
  ...
  private void setShapeStyleAccordingToCurrentChartElement() {
    try {

       this.setGUIComponentsValueAccordingToShapeStyle();
  ...
  private void setGUIComponentsValueAccordingToShapeStyle() {
    this.widthTextField.setText( " " + Unit.convertPixelToCM( this.shapeStyle.getDimensionWidth()) + " cm" );
    this.heightTextField.setText( " " + Unit.convertPixelToCM( this.shapeStyle.getDimensionHeight()) + " cm" );
    this.rotationAngleTextField.setText( " " + this.shapeStyle.getRotationDegreeAngle() + " degree" );
    this.rotationAngleScrollBar.setValue( (int) - this.shapeStyle.getRotationDegreeAngle() ); // 스크롤바의 특성상 부호가 역이어야 한다.
    this.locationXTextField.setText( " " + Unit.convertPixelToCM( this.shapeStyle.getLocationX() ) + " cm" );
    this.locationYTextField.setText( " " + Unit.convertPixelToCM( this.shapeStyle.getLocationY()) + " cm" );
    this.widthRatioTextField.setText( " 100%" );
    this.heightRatioTextField.setText( " 100%" );
    this.firstWidth = this.shapeStyle.getDimensionWidth();
    this.firstHeight = this.shapeStyle.getDimensionHeight();
    this.setLineWidthTextField();
    Color fillColor = this.shapeStyle.getFillColor(),
          lineColor = this.shapeStyle.getLineColor();
    if( fillColor != null ) {
      ...
      if( this.shapeStyle != null ) {
         fe = this.shapeStyle.getFillEffect();
         if( fe != null ) {
    ...
    if( lineColor != null ) {
      ...
      FillEffect lineTexture = null;
      if( this.shapeStyle != null ) {
         lineTexture = this.shapeStyle.getLineTexture();
         if( lineTexture != null ) {
  ...
  public void show() {
    ...
    this.setShapeStyleAccordingToCurrentChartElement();

    super.show();
  }

  public void reLocate() {
    Utility.locateCenterOnScreen(this);
  }

  public static ShapeStyle getNewShapeStyle() {
    shapeStyleEditor.show();
    return shapeStyleEditor.shapeStyle;
  }
      ...
      if( index == 1 ) { // 채우기 없음을 선택하면, 채우기 칼라를 널로 변경한다.
        ...
        this.halfTransparentCheckBox.setEnabled( false );
         ...
         if( chooserFillColor == null ) {
            chooserFillColor = this.shapeStyle.getFillColor();
         }
         ...
         if( c == null ) {
           Utility.debug(this, "Null Color. canceled changing fill color." );
           return;
         } else {
           chooserFillColor = c;
         }
         ...
         if( this.shapeStyle != null ) {
            refFillEffect = this.shapeStyle.getFillEffect();
         }

         FillEffect fillEffect = FillEffectEditor.getNewFillEffect( refFillEffect );

         if( fillEffect != null ) {
            this.setFillEffect( fillEffect );
            this.halfTransparentCheckBox.setSelected( false );
            this.halfTransparentCheckBox.setEnabled( false );
         }
      }
      Utility.debug(this, "fill color selected index = " + index );
      // this.fillColorComboBox.setSelectedIndex(0);
  }

  public void setFillEffect(FillEffect fe) {
      Utility.debug(this, "Setting Fill Effect ......" );
      this.shapeStyle.setFillEffect( fe );
      this.fillColorComboBoxRenderer.changeFillEffect( fe );
      this.fillColorComboBox.setSelectedIndex( 0 );
  }
  ...
  private boolean isHeightIncreased(AdjustmentEvent e) {
     boolean value = false;
     if( this.preHeightScrollBarValue > e.getValue() ) { // 스크롤 바의 특성상 판별 부호가 역으로 되어야 한다.
       value = true;
     }
  ...
  private void increaseHeight(AdjustmentEvent e) {
     if( this.isHeightIncreased( e ) ) { // 높이 값을 증가 시키는 경우
        this.shapeStyle.increaseDimensionHeight( Unit.convertCMToPixel( 0.1 ) );
      } else {                            // 높이 값을 감소 시키는 경우
        this.shapeStyle.increaseDimensionHeight( Unit.convertCMToPixel( -0.1 ) );
      }
      this.heightTextField.setText( " " + Unit.convertPixelToCM( shapeStyle.getDimensionHeight() ) + "cm" );
      this.heightRatioTextField.setText( " " + this.getHeightRatioPercent() + "%" );
      Utility.debug(this, "h = " + Unit.convertPixelToCM( this.shapeStyle.getDimensionHeight() ) );
  }

  private boolean isWidthIncreased(AdjustmentEvent e) {
    boolean value = false;
    if( this.preWidthScrollBarValue > e.getValue() ) { // 스크롤 바의 특성상 판별 부호가 역으로 되어야 한다.
      value = true;
    }
  ...
  private void increaseWidth(AdjustmentEvent e ) {
    if( this.isWidthIncreased(e) ) { // 폭 값을 증가 시키는 경우
       this.shapeStyle.increaseDimensionWidth( Unit.convertCMToPixel( 0.1 ) );
    } else {                         // 폭 값을 감소 시키는 경우
       this.shapeStyle.increaseDimensionWidth( Unit.convertCMToPixel( - 0.1 ) );
    }
    this.widthTextField.setText( " " + Unit.convertPixelToCM( shapeStyle.getDimensionWidth() ) + "cm" );
    this.widthRatioTextField.setText( " " + this.getWidthRatioPercent() + "%" );
    Utility.debug(this, "w = " + Unit.convertPixelToCM( this.shapeStyle.getDimensionWidth() ) );
  }
  ...
  void heightValueScrollBar_adjustmentValueChanged(AdjustmentEvent e) {
      ...
      if( this.widthHeightRatioFixedCheckBox.isSelected() ) {
        double fixedRatio = this.getHeightRatioPercent() / 100.0 ; // 퍼센티지를 실 값으로 변환
        double width = this.firstWidth*fixedRatio;
        this.shapeStyle.setDimension(width, this.shapeStyle.getDimensionHeight() );
        this.widthTextField.setText( " " + Unit.convertPixelToCM( shapeStyle.getDimensionWidth() ) + "cm" );
        // 폭 비율을 높이 비율과 일치시킨다.
  ...
  void widthValueScrollBar_adjustmentValueChanged(AdjustmentEvent e) {
      ...
      if( this.widthHeightRatioFixedCheckBox.isSelected() ) {
        double fixedRatio = this.getWidthRatioPercent() / 100.0 ; // 퍼센티지를 실 값으로 변환
        double height = this.firstHeight*fixedRatio;
        this.shapeStyle.setDimension(this.shapeStyle.getDimensionWidth(), height );
        this.heightTextField.setText( " " + Unit.convertPixelToCM( shapeStyle.getDimensionHeight() ) + "cm" );
        // 높이 비율을 폭 비율과 일치시킨다.
  ...
  void rotationAngleScrollBar_adjustmentValueChanged(AdjustmentEvent e) {
     this.shapeStyle.setRotationDegreeAngle( - e.getValue() );  // 스크롤 바의 특성상 부호가 역으로 되어야 한다.
     this.rotationAngleTextField.setText( " " + this.shapeStyle.getRotationDegreeAngle() + " degree" );
     Utility.debug( this, "angle : " +  this.shapeStyle.getRotationDegreeAngle() );
  }
  ...
  void rotationAngleTextField_actionPerformed(ActionEvent e) {
     ...
     try {
        ...
        this.shapeStyle.setRotationDegreeAngle( degree );
     } catch (Exception ex ) {
        ex.printStackTrace();
     }
     this.rotationAngleTextField.setText( " " + this.shapeStyle.getRotationDegreeAngle() + " degree");
     this.rotationAngleScrollBar.setValue( (int) - this.shapeStyle.getRotationDegreeAngle() ); // 스크롤 바의 특성상 부호가 역으로 되어야 한다.
  }

  private boolean isLocationXIncreased(AdjustmentEvent e) {
    boolean value = false;
    if( this.preLocationXScrollBarValue > e.getValue() ) { // 스크롤 바의 특성상 판별 부호가 역으로 되어야 한다.
      value = true;
    }
  ...
  private void increaseLocationX(AdjustmentEvent e ) {
    if( this.isLocationXIncreased(e) ) { // 위치 X 값을 증가 시키는 경우
       this.shapeStyle.increaseLocationX( Unit.convertCMToPixel( 0.5 ) );
    } else {                         // 위치 X 값을 감소 시키는 경우
       this.shapeStyle.increaseLocationX( Unit.convertCMToPixel( -0.5 ) );
    }
    Utility.debug(this, "x = " + Unit.convertPixelToCM( this.shapeStyle.getLocationX() ) );
  }

  void locationXScrollBar_adjustmentValueChanged(AdjustmentEvent e) {
     this.increaseLocationX( e );
     double locX = Unit.convertPixelToCM( this.shapeStyle.getLocationX() ) ;
     locX *= 2.0;
     locX = Math.rint( locX );
     locX /= 2.0;
  ...
  private boolean isLocationYIncreased(AdjustmentEvent e) {
    boolean value = false;
    if( this.preLocationYScrollBarValue > e.getValue() ) { // 스크롤 바의 특성상 판별 부호가 역으로 되어야 한다.
      value = true;
    }
  ...
  private void increaseLocationY(AdjustmentEvent e ) {
    if( this.isLocationYIncreased(e) ) { // 위치 X 값을 증가 시키는 경우
       this.shapeStyle.increaseLocationY( Unit.convertCMToPixel( 0.5 ) );
    } else {                         // 위치 X 값을 감소 시키는 경우
       this.shapeStyle.increaseLocationY( Unit.convertCMToPixel( -0.5 ) );
    }
    Utility.debug(this, "y = " + Unit.convertPixelToCM( this.shapeStyle.getLocationY() ) );
  }

  void locationYScrollBar_adjustmentValueChanged(AdjustmentEvent e) {
     this.increaseLocationY( e );
     double locY = Unit.convertPixelToCM( this.shapeStyle.getLocationY() ) ;
     locY *= 2.0;
     locY = Math.rint( locY );
     locY /= 2.0;
  ...
  void locationXTextField_actionPerformed(ActionEvent e) {
    ...
    locX = locX.trim();
    try {
       double xCm = Double.valueOf(locX).doubleValue() ,
       xPxl = Unit.convertCMToPixel( xCm );
       this.shapeStyle.setLocationX( xPxl );
  ...
  void locationYTextField_actionPerformed(ActionEvent e) {
    ...
    locY = locY.trim();
    try {
       double yCm = Double.valueOf(locY).doubleValue() ,
       yPxl = Unit.convertCMToPixel( yCm );
       this.shapeStyle.setLocationY( yPxl );
  ...
  private double getWidthRatioPercent() {
    double value = this.shapeStyle.getDimensionWidth() / this.firstWidth;
    value = Math.rint( value * 100 );
    return value;
  }

  private double getHeightRatioPercent() {
    double value = this.shapeStyle.getDimensionHeight() / this.firstHeight;
    value = Math.rint( value * 100 );
    return value;
  }
  ...
  void heightTextField_actionPerformed(ActionEvent e) {
    ...
    try {
      ...
      h = Unit.convertCMToPixel( h ); // 단위 변환
      this.shapeStyle.setDimension( this.shapeStyle.getDimensionWidth(), h);
      if( this.widthHeightRatioFixedCheckBox.isSelected() ) {
        double fixedRatio = this.getHeightRatioPercent() / 100.0 ; // 퍼센티지를 실 값으로 변환
        double width = this.firstWidth*fixedRatio;
        this.shapeStyle.setDimension(width, h );
        this.widthTextField.setText( " " + Unit.convertPixelToCM( shapeStyle.getDimensionWidth() ) + "cm" );
        this.heightTextField.setText( " " + Unit.convertPixelToCM( shapeStyle.getDimensionHeight() ) + "cm" );
        // 폭 비율을 높이 비율과 일치시킨다.
        this.widthRatioTextField.setText( " " + this.getHeightRatioPercent() + "%" );
  ...
  void widthTextField_actionPerformed(ActionEvent e) {
    ...
    try {
      ...
      w = Unit.convertCMToPixel( w ); // 단위 변환
      this.shapeStyle.setDimension( w, this.shapeStyle.getDimensionHeight() );
      if( this.widthHeightRatioFixedCheckBox.isSelected() ) {
        double fixedRatio = this.getWidthRatioPercent() / 100.0 ; // 퍼센티지를 실 값으로 변환
        double height = this.firstHeight*fixedRatio;
        this.shapeStyle.setDimension(w, height );
        this.widthTextField.setText( " " + Unit.convertPixelToCM( shapeStyle.getDimensionWidth() ) + "cm" );
        this.heightTextField.setText( " " + Unit.convertPixelToCM( shapeStyle.getDimensionHeight() ) + "cm" );
        // 폭 비율을 높이 비율과 일치시킨다.
        this.widthRatioTextField.setText( " " + this.getWidthRatioPercent() + "%" );
  ...
  void heightTextField_mouseExited(MouseEvent e) {
    heightTextField_actionPerformed( null );
  }

  void widthTextField_mouseExited(MouseEvent e) {
    widthTextField_actionPerformed( null );
  }

  private boolean isHeightRatioIncreased(AdjustmentEvent e) {
     boolean value = false;
     if( this.preHeightRatioScrollBarValue > e.getValue() ) { // 스크롤 바의 특성상 판별 부호가 역으로 되어야 한다.
       value = true;
     }
  ...
  private void increaseHeightRatio(AdjustmentEvent e) {
     double heightRatio = this.shapeStyle.getDimensionHeight()/this.firstHeight;
     if( this.isHeightRatioIncreased( e ) ) { // 높이 값을 증가 시키는 경우
      ...
      if( this.widthHeightRatioFixedCheckBox.isSelected() ) {
        ...
        this.shapeStyle.setDimension( w, h );
        this.widthTextField.setText( " " + Unit.convertPixelToCM( shapeStyle.getDimensionWidth() ) + "cm" );
        this.widthRatioTextField.setText( " " + this.getHeightRatioPercent() + "%" );
      } else {
        w = this.shapeStyle.getDimensionWidth();
        this.shapeStyle.setDimension( w, h );
      }
  ...
  void heightRatioScrollBar_adjustmentValueChanged(AdjustmentEvent e) {
     increaseHeightRatio( e );
  }

  private boolean isWidthRatioIncreased(AdjustmentEvent e) {
     boolean value = false;
     if( this.preWidthRatioScrollBarValue > e.getValue() ) { // 스크롤 바의 특성상 판별 부호가 역으로 되어야 한다.
       value = true;
     }
  ...
  private void increaseWidthRatio(AdjustmentEvent e) {
     double widthRatio = this.shapeStyle.getDimensionWidth()/this.firstWidth;
     if( this.isWidthRatioIncreased( e ) ) { // 높이 값을 증가 시키는 경우
      ...
      if( this.widthHeightRatioFixedCheckBox.isSelected() ) {
        ...
        h = this.shapeStyle.getDimensionHeight();
        this.shapeStyle.setDimension( w, h );
      }
  ...
  void heightRatioTextField_actionPerformed(ActionEvent e) {
      ...
      try {
         double heightRatio = Double.valueOf(hRatioStr).doubleValue()/100.0; // 퍼센트를 실 값으로 변환
         double w, h;
         h = this.firstHeight*heightRatio;
  ...
  void widthRatioTextField_actionPerformed(ActionEvent e) {
      ...
      try {
         double widthRatio = Double.valueOf(wRatioStr).doubleValue()/100.0; // 퍼센트를 실 값으로 변환
         double w, h;
         w = this.firstWidth*widthRatio;
  ...
  void lineKindComboBox_actionPerformed(ActionEvent e) {
     ...
     Utility.debug(this, "line kind selected index = " + i );
     this.lineKindComboBoxRenderer.setSelectedIndex( i );
     this.shapeStyle.setLineStroke( this.lineKindComboBoxRenderer.getStroke(i) );
  }

  private boolean isLineWidthIncreased(AdjustmentEvent e) {
     boolean value = false;
     if( this.preLineWidthScrollBarValue > e.getValue() ) { // 스크롤바의 특성상 부호가 역이어야 한다.
       value = true;
     } else {
       value = false;
     }
  ...
  private void increaseLineWidth(AdjustmentEvent e) {
     double lw = this.shapeStyle.getLineWidth();
     double dlw = Unit.convertPointToPixel( 0.25 );
     if( isLineWidthIncreased( e ) ) {
        lw += dlw;
     } else {
        lw -= dlw;
     }
     this.shapeStyle.setLineWidth( lw );
     this.setLineWidthTextField();
  }

  private void setLineWidthTextField() {
     double lw = this.shapeStyle.getLineWidth();
     double lwPnt = Unit.convertPixelToPoint( lw );
  ...
  void lineWidthTextField_actionPerformed(ActionEvent e) {
     ...
     try {
       ...
       this.shapeStyle.setLineWidth( Unit.convertPointToPixel(lwPnt) );
       this.setLineWidthTextField();
     } catch (Exception ex) {
       ex.printStackTrace();
     }
  ...
  void lineWidthTextField_mouseExited(MouseEvent e) {
     lineWidthTextField_actionPerformed( null );
  }
      ...
      if( index == 1 ) { // 선 없음을 선택하면, 선 칼라를 널로 설정한다.
        ...
        this.setLineColor( null );
         ...
         if( chooserLineColor == null ) {
            chooserLineColor = this.shapeStyle.getLineColor();
            if( chooserLineColor == null ) {
         ...
         if( c == null ) {
           Utility.debug(this, "Null Color. canceled changing line color." );
           return;
         } else {
           chooserLineColor = c;
         }
         this.setLineColor( c );
         //this.lineColorComboBoxRenderer.changeColor( chooserLineColor );
         //this.shapeStyle.setLineColor( chooserLineColor );
      } else if( index == 3 ) { // 선 무늬를 설정하는 경우
         FillEffect refLineTexture = null;
         if( this.shapeStyle != null ) {
            refLineTexture = this.shapeStyle.getLineTexture();
         }

         FillEffect lineTexure = LineTextureEditor.getNewLineTexture( refLineTexture );

         if( lineTexure != null ) {
            this.shapeStyle.setLineTexture( lineTexure );
            this.lineColorComboBoxRenderer.changeFillEffect( lineTexure );
         }
      }
      Utility.debug(this, "line color selected index = " + index );
  ...
  public void setFillColor(Color c) {
      ...
      this.shapeStyle.setFillColor( c );
      this.fillColorComboBox.setSelectedIndex( 0 );
  }

  public void setLineColor(Color c) {
      this.lineColorComboBoxRenderer.changeColor( c );
      this.shapeStyle.setLineColor( c );
  }
  ...
  void halfTransparentCheckBox_actionPerformed(ActionEvent e) {
      ...
      if( selected ) {
         ...
         FillEffect fe = this.fillColorComboBoxRenderer.getFillEffect();
         Color c = this.chooserFillColor;
