...
public class ArcTester extends Panel {
  ...
  private Shape getArc() {

    return new Arc2D.Double( x - r, y -r, 2*r, 2*r, start, extent, Arc2D.PIE );

//    return ShapeUtilities.getArc( x, y, r, (r*0.9), start, extent, Arc2D.PIE );
  ...
  public void paint(Graphics g) {
    ...
    Point2D [] ctrlPoints = ShapeUtilities.getPieControlPoints( pie );
  ...
  public static void main(String[] args) {
    ...
    ArcTester ArcTester = new ArcTester();
    f.add( ArcTester, BorderLayout.CENTER );
    f.setVisible( true );
