...
public class TableModelDbfOld extends AbstractTableModel implements DebugInterface {
	...
	public TableModelDbfOld() throws Exception {
		this(null);
	}

	public TableModelDbfOld(File fileDbf) throws Exception {
		this.setDbf(fileDbf);
	}
