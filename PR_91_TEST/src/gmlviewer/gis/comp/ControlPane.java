...
public abstract class ControlPane
  ...
  public void packComponents() {
    ...
    if( true || ! GmlViewerRegistry.VIEWER_CONTROLLER_AUTO_PACK ) {
      return;
    }
  ...
  protected Component createActionComponent( String command, String resDir, String iconResource ) {
    return actionFact.createActionedComponent( new JButton( command ),  command, resDir, iconResource );
  }
